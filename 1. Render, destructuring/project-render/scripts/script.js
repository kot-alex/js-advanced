...
const items = [
    new Item('images/products/product-1.jpg', "ELLERY X M'O CAPSULE", 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.', 52),
    new Item('images/products/product-2.jpg', "ELLERY X M'O CAPSULE", 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.', 52),
    new Item('images/products/product-3.jpg', "ELLERY X M'O CAPSULE", 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.', 52),
    new Item('images/products/product-4.jpg', "ELLERY X M'O CAPSULE", 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.', 52),
    new Item('images/products/product-5.jpg', "ELLERY X M'O CAPSULE", 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.', 52),
    new Item('images/products/product-6.jpg', "ELLERY X M'O CAPSULE", 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.', 52),
];

function createItem({ image, title, description, price }) {
    return `<figure class="products-card">
                        <div class="products-card-image">
                            <img class="products-card-img" src="${image}" alt="product 1">
                            <div class="products-card-overlay">
                                <button class="products-card-overlay-button" type="button"><svg
                        ...
                        <figcaption class="products-card-info">
                            <a class="products-card-link" href="product.html">
                                <h3 class="products-card-link-heading">${title}</h3>
                                <p class="products-card-link-text">${description}</p>
                            </a>
                            <p class="products-card-pricetag">$${price}</p>
                        </figcaption>
                    </figure>`
}

function createProductsList(arrOfItems = items) {
    let productsHtml = arrOfItems.map(function (product) {
        return createItem(product);
    }
    ).join('');

    $productsItems.insertAdjacentHTML('beforeend', productsHtml);
}
