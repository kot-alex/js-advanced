...
Vue.component('items-list', {
    ...
    <card v-for="item of list" :key="item.id" v-bind:item="item" @add-to-cart="addToCartHandler"></card>
...
Vue.component('card', {
    ...
    <div class="products-card-image">
        ...
        <div class="products-card-overlay">
            <button @click="addToCartHandler" class="products-card-overlay-button" type="button"><svg
...
Vue.component('cart-item', {
    template: `<div v-if="item.quantity != 0" class="cart-item">
    ...
    <div class="cart-item-description">
        ...
        <ul class="cart-item-text">
            ...
            <li>Quantity:<input class="cart-item-quantity" v-model.number="item.quantity" type="number" min="0" max="20"></li>
        </ul>
    </div>
</div>`,
    methods: {
...
Vue.component('items-in-cart', {
    ...
    <section class="cart-items">
        ...
        <cart-item v-for="item of cart" :key="item.id" v-bind:item="item" @remove-from-cart="removeFromCartHandler"></cart-item>
...
Vue.component('index-page', {
    ...
    <main>
        ...
        <items-list v-bind:list="list" @add-to-cart="addToCartHandler"></items-list>
    </main>
    <benefits></benefits>
    <feedback></feedback>
...
Vue.component('cart-page', {
    ...
    <main>
        ...
        <items-in-cart v-if="cart.length>0" v-bind:cart="cart" @remove-from-cart="removeFromCartHandler" @clear-cart="clearCartHandler" v-bind:cart-total-price="cartTotalPrice"></items-in-cart>
